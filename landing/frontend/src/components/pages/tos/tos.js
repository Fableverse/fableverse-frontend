...
function Tos () {
  return (
    <div>
      <h2>Fableverse, LLC Terms of Service</h2>
      <h3>1. Terms</h3>
      <p>
        By accessing the website at{' '}
        <a href='https://fableverse.com'>https://fableverse.com</a>, you are
      ...
      <ol type='a'>
        <li>
          ...
          materials (information or software) on Fableverse, LLC's website for
        ...
        <li>
          ...
          restrictions and may be terminated by Fableverse, LLC at any time.
      ...
      <ol type='a'>
        <li>
          The materials on Fableverse, LLC's website are provided on an 'as is'
          basis. Fableverse, LLC makes no warranties, expressed or implied, and
        ...
        <li>
          Further, Fableverse, LLC does not warrant or make any representations
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall Fableverse, LLC or its suppliers be liable for any
        damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption) arising out of the use or
        inability to use the materials on Fableverse, LLC's website, even if
        Fableverse, LLC or a Fableverse, LLC authorized representative has been
      ...
      <p>
        The materials appearing on Fableverse, LLC's website could include
        technical, typographical, or photographic errors. Fableverse, LLC does
        not warrant that any of the materials on its website are accurate,
        complete or current. Fableverse, LLC may make changes to the materials
        contained on its website at any time without notice. However Fableverse,
        LLC does not make any commitment to update the materials.
      </p>
      <h3>6. Links</h3>
      <p>
        Fableverse, LLC has not reviewed all of the sites linked to its website
        and is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement by Fableverse, LLC of
        the site. Use of any such linked website is at the user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        Fableverse, LLC may revise these terms of service for its website at any
